...
Sube también la carpeta `assets` y `favicon.ico` a la raíz del repositorio. El logo se muestra en las cuatro páginas. Si la pestaña sigue mostrando el icono anterior, cierra y vuelve a abrir la pestaña o recarga sin caché.
